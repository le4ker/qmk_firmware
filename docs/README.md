...
?> **Advanced** [Use The Source](newbs.md) <br> More powerful, but harder to
use.
...
QMK has lots of features to explore, and a good deal of reference documentation
to dig through. Most features are taken advantage of by modifying your
[keymap](keymap.md), and changing the [keycodes](keycodes.md).
